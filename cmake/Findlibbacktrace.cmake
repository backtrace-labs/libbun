...
if (LIBBACKTRACE_LIBRARIES AND LIBBACKTRACE_INCLUDE_DIR)
  ...
  if (LIBBACKTRACE_INCLUDE_DIR AND LIBBACKTRACE_LIBRARIES)
    set(LIBBACKTRACE_FOUND TRUE)
  endif()

  if (LIBBACKTRACE_FOUND)
    if (NOT LIBBACKTRACE_FIND_QUIETLY)
      message(STATUS "Found LIBBACKTRACE: ${LIBBACKTRACE_INCLUDE_DIR}")
      message(STATUS "Found LIBBACKTRACE: ${LIBBACKTRACE_LIBRARIES}")
